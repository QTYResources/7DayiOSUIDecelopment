...
- (void)viewDidLoad {
    [super viewDidLoad];
    // iOS系统中地图开发的相关接口与方法都封装在MapKit.framework这个框架找那个。因此需要在工程配置页面中的Build Phases页面的Link Binary With Libraries中添加MapKit.framework，并在使用的地方导入#import <MapKit/MapKit.h>头文件
    // 初始化地图控件
