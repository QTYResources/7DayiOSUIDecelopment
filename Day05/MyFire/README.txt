...
（8）粒子效果的创建基于两个部分，一部分是粒子发射器，用于配置粒子的整体效果；另一部分是粒子单元，用于配置粒子的具体属性。
...
（9）CAEmitterLayer中的属性主要是对粒子的创建周期、发射速度等整体属性进行设置，而具体粒子的UI展现、颜色、速度以及各种随机选项等是由粒子单元CAEmitterCell来进行设置与维护的。
